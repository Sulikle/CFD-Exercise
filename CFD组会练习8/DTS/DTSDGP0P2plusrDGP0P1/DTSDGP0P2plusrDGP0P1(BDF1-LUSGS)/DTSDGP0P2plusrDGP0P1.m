...
ylabel('数值U','fontsize',14)
 title('DG(P0P2)+rDG(P0P1) BDF1 LUSGS数值解与解析解(U)','fontsize',16)
hold off
...
lgd=legend([H1,H2,H3],'DG(P0P2)+rDG(P0P1)','Slope=2','Slope=3');
lgd.FontSize=12;
...
xlabel('位置x','fontsize',14)
ylabel('数值U','fontsize',14)
title('DG(P0P2)+rDG(P0P1) BDF1 LUSGS数值解与解析解(Ux)','fontsize',16)
hold off
