function [Unumsolution,n]=P0P2plusrP0P1BDF1(Unit,CFL,endtau,tol,Grid,Deltax,nsdv,omega0,omega1,omega2,omega3,omegab)
dimention=2;
%%Pre-proceeding
...
if nsdv==1
fprintf('DG(P0P2)+rDG(P0P1) Jacobi 达到稳态所需要的时间是：%f 秒\n',n)
elseif nsdv==2
    fprintf('DG(P0P2)+rDG(P0P1) LUSGS 达到稳态所需要的时间是：%f 秒\n',n)
end
end
