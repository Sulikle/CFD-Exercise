function [n,Ul2errors,Vl2errors]=subDGP0P2plusrDGP0P1(Unit,CFL,endtau,tol,belta,nsdv,nexplicit,omega0,omega1,omega2,omega3,omegab)
%% Preproceeding
...
%% Explicit
if nexplicit==1
        [Unumsolution,n]=P0P2plusrP0P1Explicit(Unit,CFL,endtau,tol,Grid,Deltax,nsdv,omega0,omega1,omega2,omega3,omegab);
...
xlabel('位置x','fontsize',14)
ylabel('数值U','fontsize',14)
 title('DG(P0P2)+rDG(P0P1) TVDRK3 数值解与解析解(U)','fontsize',16)
hold off       
...
xlabel('位置x','fontsize',14)
ylabel('数值U','fontsize',14)
title('DG(P0P2)+rDG(P0P1) TVDRK3 数值解与解析解(Ux)','fontsize',16)
hold off
    end
...
[Unumsolution,n]=P0P2plusrP0P1BDF1(Unit,CFL,endtau,tol,Grid,Deltax,nsdv,omega0,omega1,omega2,omega3,omegab);
        Ul2errors=UL2errors(Unumsolution,Deltax,Grid);
        Vl2errors=VL2errors(Unumsolution,Deltax,Grid);
%% Jacobi
if nsdv==1
...
xlabel('位置x','fontsize',14)
ylabel('数值U','fontsize',14)
 title('DG(P0P2)+rDG(P0P1)Jacobi数值解与解析解(U)','fontsize',16)
hold off
...
xlabel('位置x','fontsize',14)
ylabel('数值U','fontsize',14)
title('DG(P0P2)+rDG(P0P1) Jacobi 数值解与解析解(Ux)','fontsize',16)
hold off
...
xlabel('位置x','fontsize',14)
ylabel('数值U','fontsize',14)
 title('DG(P0P2)+rDG(P0P1) LUSGS数值解与解析解(U)','fontsize',16)
hold off
...
xlabel('位置x','fontsize',14)
ylabel('数值U','fontsize',14)
title('DG(P0P2)+rDG(P0P1) LUSGS 数值解与解析解(Ux)','fontsize',16)
hold off
