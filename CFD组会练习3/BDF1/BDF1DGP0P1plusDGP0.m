...
Unit=64;CFL=0.01;endtau=10;endx=1;deltax=endx/Unit;numberx=endx/deltax+1;
tol=10^(-10);
...
[UDGP0P1plusDGP0,endtau0plus0]=subDGP0P1plusDGP0(Unit,CFL,endtau);
...
figure
 ...
 Unumsolution1(1,1)=UDGP0P1plusDGP0(1,1)-0.5*UDGP0P1plusDGP0(2,1)*deltax;Unumsolution1(1,2)=UDGP0P1plusDGP0(1,1)+0.5*UDGP0P1plusDGP0(2,1)*deltax;
 plot(x,Unumsolution1,'-c.','linewidth',1.5);hold on
 H1=plot(x,Unumsolution1,'-c.','linewidth',1.5);hold on
for i=2:numberx-1
    x=(i-1)*deltax:deltax:i*deltax;
    Unumsolution1(1,1)=UDGP0P1plusDGP0(1,i)-0.5*UDGP0P1plusDGP0(2,i)*deltax;Unumsolution1(1,2)=UDGP0P1plusDGP0(1,i)+0.5*UDGP0P1plusDGP0(2,i)*deltax;
