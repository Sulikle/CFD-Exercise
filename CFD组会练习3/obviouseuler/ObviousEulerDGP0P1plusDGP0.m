...
[UDGP0P1plusDGP0,endtau0plus0]=subDGP0P1plusDGP0(Unit,CFL,endtau);%acquire u and ux
...
title('面循环显示欧拉数值解与解析解(U)，单元格数为64','fontsize',16)
hold off
...
xlabel('位置x','fontsize',14)
ylabel('数值U','fontsize',14)
title('面循环显示欧拉数值解与解析解(Ux)，单元格数为64','fontsize',16)
hold off
