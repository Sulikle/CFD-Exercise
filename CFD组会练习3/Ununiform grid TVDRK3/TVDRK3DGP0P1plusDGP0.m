...
close all
%% Pre-processing
Unit=8;CFL=0.01;endtau=1;endx=1;deltax=1/Unit;numberx=endx/deltax+1;
% %记录内点位置
...
[UDGP0P1plusDGP0,Grid,endtau01plus0]=subDGP0P1plusDGP0(Unit,CFL,endtau);%acquire u and ux
...
title('Nonuniform grid-TVDRK3(U)，8 elements','fontsize',16)
hold off
...
xlabel('位置x','fontsize',14)
ylabel('数值U','fontsize',14)
title('Nonuniform grid-TVDRK3(Ux)，8 elements','fontsize',16)
hold off

%determine the accuracy of space U
[U,G,~]=subDGP0P1plusDGP0(8,CFL,endtau);
Acc(1,1)=AccuracyU(8,U,G);
[U,G,~]=subDGP0P1plusDGP0(16,CFL,endtau);
Acc(1,2)=AccuracyU(16,U,G);
[U,G,~]=subDGP0P1plusDGP0(32,CFL,endtau);
Acc(1,3)=AccuracyU(32,U,G);
[U,G,~]=subDGP0P1plusDGP0(64,CFL,endtau);
