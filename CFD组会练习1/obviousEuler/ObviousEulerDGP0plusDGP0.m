...
close all
%% Pre-processing
Unit=64;CFL=0.01;endtau=10;endx=1;deltax=1/Unit;numberx=endx/deltax+1;
Uexasolution=zeros(2,numberx);
UDGP0plusDGP0=zeros(2,numberx-1);
...
[UDGP0plusDGP0,endtau0plus0]=subDGP0plusDGP0(Unit,CFL,endtau);%acquire u and ux
...
title('面循环显示欧拉数值解与解析解(U)，单元格数为8','fontsize',16)
hold off
...
xlabel('位置x','fontsize',14)
ylabel('数值U','fontsize',14)
title('面循环显示欧拉数值解与解析解(Ux)，单元格数为8','fontsize',16)
hold off
